...
var sources = []*ast.Source{
	&ast.Source{Name: "cli/dispatchers/graphql/graph/mutations.graphqls", Input: `type Mutation {
  #Account
...
`, BuiltIn: false},
	&ast.Source{Name: "cli/dispatchers/graphql/graph/queries.graphqls", Input: `type Query {
...
`, BuiltIn: false},
	&ast.Source{Name: "cli/dispatchers/graphql/graph/schemas/todo.graphqls", Input: `# just to pass the glqgen validation
type Todo {
  id: ID!
}
`, BuiltIn: false},
	&ast.Source{Name: "cli/dispatchers/graphql/graph/schemas/utils.graphqls", Input: `directive @goModel(model: String, models: [String!]) on OBJECT
    | INPUT_OBJECT
    | SCALAR
    | ENUM
    | INTERFACE
